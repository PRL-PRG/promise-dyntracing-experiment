...
# FIXME aggregated_functions <- load_local_csv("aggregated_functions.csv") #
...
basic_info <- 
  ...
  summarise(
    ...
    n.datasets=n(),
    n.functions=sum(as.character(n.functions)),
    n.calls=sum(as.character(n.calls)),
    n.promises=sum(as.character(n.promises)),
    n.promise.forces=sum(as.character(n.promise.forces)),
    n.promise.lookups=sum(as.character(n.promise.lookups)), 
    n.alien.promises=sum(as.character(n.alien.promises)),
    n.alien.promise.forces=sum(as.character(n.alien.promise.forces))
  )
