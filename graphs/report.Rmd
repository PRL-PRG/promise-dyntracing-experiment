...
``` {r, "number of accesses to a promise, separate per package", echo=FALSE, warning=FALSE, fig.width=10, fig.height=10}
...
``` {r, "promise code types, separate per package", echo=FALSE, warning=FALSE, fig.width=10, fig.height=10}
...
``` {r, "what do promises return",  echo=FALSE, fig.width=10, fig.height=5}
return_types <- 
...
<!--``` {r, "promise forces by types, per package", echo=FALSE, warning=FALSE, fig.width=10, fig.height=5}
...
<!--
```{r, "promise forces by types, separate per package", echo=FALSE, fig.width=10, fig.height=4.5}
actual_distances <- 
