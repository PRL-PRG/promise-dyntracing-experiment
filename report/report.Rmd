...
```{r echo = FALSE, out.width="1000px"}
show_graph("argument_count_by_call_depth.png")
```

```{r echo = FALSE}
show_table("argument_count_by_call_depth")
```

### Promise Depth

```{r echo = FALSE, out.width="1000px"}
show_graph("argument_count_by_promise_depth.png")
```

```{r echo = FALSE}
show_table("argument_count_by_promise_depth")
```

### Nested Promise Depth

```{r echo = FALSE, out.width="1000px"}
show_graph("argument_count_by_nested_promise_depth.png")
```

```{r echo = FALSE}
show_table("argument_count_by_nested_promise_depth")
```
