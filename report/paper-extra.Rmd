...
datatable(context_sensitive_lookup_symbols)
```
...
save_local_graph(argument_promise_call_depth_graph, "argument_promise_call_depth_graph.pdf", width=12, height=2.5)
```
