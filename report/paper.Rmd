...
```{r eval = TRUE, echo = FALSE}
CountEscArg <- sum(escaped_argument_count_by_nature$argument_count)
```

Of the `r format_as_absolute(CountPromiseArgument)` promises we have
observed, only `r format_as_absolute(CountEscArg)` escape. This is a rather small number, and we
